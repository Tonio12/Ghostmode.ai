...
import {
  ...
  FadeInStagger,
  FadeInStaggerItem,
} from '@/components/magicui/fade-in';
  ...
  return (
    <div className="p-4 md:p-8 w-full">
      ...
      <div className="relative mb-12 rounded-xl overflow-hidden">
        ...
        >
          <div>
            ...
            >
              Welcome to{' '}
              <AnimatedGradientText>Ghostmode.ai</AnimatedGradientText>
            </motion.h1>
            <motion.p
            ...
            >
              Manage your social media automation and set healthy boundaries for
      ...
      >
        <FadeInStaggerItem className="border rounded-xl p-6 shadow-sm bg-gradient-to-br from-background to-primary/5 relative overflow-hidden group hover:shadow-md transition-all">
          ...
          <Button
            variant="ghost"
            size="sm"
            className="mt-4 text-xs px-0 flex items-center hover:text-primary"
          >
        ...
        <FadeInStaggerItem className="border rounded-xl p-6 shadow-sm bg-gradient-to-br from-background to-primary/5 relative overflow-hidden group hover:shadow-md transition-all">
          ...
          <p className="text-3xl font-bold mb-2">0</p>
          <p className="text-muted-foreground text-sm">
            Create AI templates for automated responses
          </p>
          <Button
            variant="ghost"
            size="sm"
      ...
      <FadeInStagger
        ...
        viewAmount={0.1}
      >
        <FadeInStaggerItem className="border rounded-xl p-6 shadow-sm overflow-hidden relative">
            ...
            <div className="flex flex-col">
              <div className="flex items-center justify-center flex-col py-12">
                ...
                <p className="text-sm text-center text-muted-foreground mt-2">
                  Connect your social media accounts to see activity here
                </p>
              </div>
            </div>
          </div>
        ...
        <FadeInStaggerItem className="border rounded-xl p-6 shadow-sm overflow-hidden relative group">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center">
              <Sparkles className="h-5 w-5 text-primary mr-2" />
              <h2 className="font-semibold text-base/7">
      ...
      {/* Get Started section */}
      <FadeIn className="mt-6 md:mt-8" direction="up" threshold={0.1}>
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center">
            <Sparkles className="h-5 w-5 text-primary mr-2" />
        ...
        <FadeInStagger
          ...
          staggerDelay={0.2}
        >
          <FadeInStaggerItem className="border rounded-xl p-6 bg-background relative overflow-hidden group cursor-pointer">
            ...
            <div className="flex flex-col items-center text-center relative z-10">
              ...
              <p className="text-muted-foreground">
                Link your social media accounts to enable automation
              </p>
          ...
          <FadeInStaggerItem className="border rounded-xl p-6 bg-background relative overflow-hidden group cursor-pointer">
            ...
            <div className="flex flex-col items-center text-center relative z-10">
              ...
              <p className="text-muted-foreground">
                Set up AI templates for different types of messages
              </p>
          ...
          <FadeInStaggerItem className="border rounded-xl p-6 bg-background relative overflow-hidden group cursor-pointer">
            ...
            <div className="flex flex-col items-center text-center relative z-10">
              ...
              <p className="text-muted-foreground">
                Let AI handle your social media interactions
              </p>
      ...
      >
        ...
        <div className="flex flex-col items-center justify-center py-12">
          ...
          <p className="text-sm text-center text-muted-foreground mt-2">
            Start using Ghostmode.ai to see your analytics
          </p>
